...
function Home() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="relative bg-gradient-to-br from-primary-700 via-primary-600 to-accent-600 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24 lg:py-32">
          <div className="text-center">
            <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 animate-slide-up px-2">
            ...
            <p
              className="text-base sm:text-lg md:text-xl text-primary-100 max-w-2xl mx-auto mb-6 sm:mb-8 animate-slide-up px-4"
            ...
            >
              <Link
                to="/search"
                className="btn bg-gradient-to-r from-warm-500 to-warm-600 text-white hover:from-warm-600 hover:to-warm-700 focus:ring-warm-400 shadow-lg shadow-warm-500/30 text-sm sm:text-base"
              >
                Start Searching
              </Link>
              <Link
                to="/about"
                className="btn border-2 border-white/50 text-white hover:bg-white/10 backdrop-blur-sm focus:ring-white text-sm sm:text-base"
              >
                Learn More
              </Link>
            </div>
      ...
      {/* Stats Section */}
      <section className="py-8 sm:py-10 md:py-12 mesh-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-primary-600 via-accent-500 to-warm-500 bg-clip-text text-transparent mb-1 sm:mb-2">
                  {stat.value}
                </div>
                <div className="text-secondary-600 font-medium text-xs sm:text-sm md:text-base">
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-primary-700 via-accent-600 to-primary-600 bg-clip-text text-transparent mb-2 sm:mb-4 px-2">
              Powerful Features
            </h2>
            <p className="text-secondary-600 max-w-2xl mx-auto text-sm sm:text-base px-4">
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-secondary-900 via-primary-900 to-secondary-900 text-white relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-0 right-0 w-48 sm:w-72 md:w-96 h-48 sm:h-72 md:h-96 bg-primary-600 rounded-full mix-blend-screen filter blur-3xl opacity-20"></div>
          <div className="absolute bottom-0 left-0 w-48 sm:w-72 md:w-96 h-48 sm:h-72 md:h-96 bg-accent-600 rounded-full mix-blend-screen filter blur-3xl opacity-20"></div>
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 px-2">
            Ready to Explore?
          </h2>
          <p className="text-secondary-300 max-w-2xl mx-auto mb-6 sm:mb-8 text-sm sm:text-base px-4">
            Start searching for GitHub users and discover amazing developers and
            projects.
          </p>
          <Link
            to="/search"
            className="btn bg-gradient-to-r from-warm-500 via-primary-500 to-accent-500 text-white hover:from-warm-600 hover:via-primary-600 hover:to-accent-600 shadow-lg shadow-primary-500/30 text-sm sm:text-base"
          >
            Get Started Now
          </Link>
        </div>
